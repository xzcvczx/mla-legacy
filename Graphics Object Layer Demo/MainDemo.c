...
int main(void)
{
    ...
    #if (DISP_ORIENTATION == 0) && (defined (__PIC24FJ256DA210__) && defined (USE_FONT_RAM))
    // use the default font that is on the RAM
    (GOLGetSchemeDefault())->pFont = (void*)&AltGOLFontDefault;
   	#endif
