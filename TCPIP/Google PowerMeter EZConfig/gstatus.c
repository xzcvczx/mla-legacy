...
static SENDER_INFO to_send[] = {
  ...
  {(FUNC_OR_STRING) SignalQuality, (FUNC_ARG) 1L, FUNC_CALL},
  {(FUNC_OR_STRING) SignalQuality, (FUNC_ARG) 2L, FUNC_CALL},
  ...
  {(FUNC_OR_STRING) QueueSize, (FUNC_ARG) 1L, FUNC_CALL},
  {(FUNC_OR_STRING) QueueSize, (FUNC_ARG) 2L, FUNC_CALL},
  {(FUNC_OR_STRING) PktCount, (FUNC_ARG) 0L, FUNC_CALL},
  {(FUNC_OR_STRING) PktCount, (FUNC_ARG) 1L, FUNC_CALL},
  {(FUNC_OR_STRING) PktCount, (FUNC_ARG) 2L, FUNC_CALL},
  {(FUNC_OR_STRING) PktSkip, (FUNC_ARG) 0L, FUNC_CALL},
  {(FUNC_OR_STRING) PktSkip, (FUNC_ARG) 1L, FUNC_CALL},
  {(FUNC_OR_STRING) PktSkip, (FUNC_ARG) 2L, FUNC_CALL},
