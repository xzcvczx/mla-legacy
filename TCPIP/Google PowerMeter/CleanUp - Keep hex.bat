...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Obj-Google PowerMeter-PIC24F MRF24WB" /s /q
rmdir "Obj-Google PowerMeter-PIC24F ENC28" /s /q
rmdir "Obj-Google PowerMeter-PIC24F ENC624" /s /q
rmdir "Obj-Google PowerMeter-PIC32 MRF24WB" /s /q
rmdir "Obj-Google PowerMeter-PIC32 ENC28" /s /q
rmdir "Obj-Google PowerMeter-PIC32 ENC624" /s /q
