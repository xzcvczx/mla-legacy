...
static BYTE ServerName[] =	"tycho.usno.navy.mil";
...
static ROM BYTE RemoteURL[] = "/cgi-bin/timer.pl";
...
const ROM BYTE HTTP_CONN_OK2[] = "HTTP/1.1 200 OK\r\nDate: ";
...
void ProcessTimeString (BYTE * buffer)
{
    ...
    if ((!strncmp((char *)HTTP_CONN_OK, (char *)buffer, i)) || (!strncmp((char *)HTTP_CONN_OK2, (char *)buffer, i)))
    {
