...
/************************************************************************
* Function EEPROMSPIPut(BYTE data)                                                       
*                                                                       
...
void EEPROMWriteByte(BYTE data, WORD address)
{
    ...
    EEPROMSPIPut(EEPROM_CMD_WRITE);
    SPIGet();

    EEPROMSPIPut(((WORD_VAL)address).v[1]);
    SPIGet();

    EEPROMSPIPut(((WORD_VAL)address).v[0]);
    SPIGet();
...
/************************************************************************
* Function: void EEPROMWriteWord(WORD data, WORD address)                                           
*                                                                       
...
WORD      counter;
    ...
    EEPROMSPIPut(addr.v[1]);
    SPIGet();
    
    EEPROMSPIPut(addr.v[0]);
    SPIGet();
