...
// The original version of this file used the Graphics PICtail EEPROM if the
// PICtail was v3 or later.  But the MASTERs demo needs the Explorer 16 EEPROM
// for other things, so we'll just use it.
#define USE_EXPLORER16_EEPROM
...
#if defined( USE_EXPLORER16_EEPROM )
