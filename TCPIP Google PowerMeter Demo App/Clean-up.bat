...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - TCPIP Google PowerMeter WiFi Demo App-dsPIC33" /s /q
rmdir "Objects - TCPIP Google PowerMeter Demo App-dsPIC33" /s /q
rmdir "Objects - TCPIP Google PowerMeter WiFi Demo App-PIC24" /s /q
rmdir "Objects - TCPIP Google PowerMeter Demo App-PIC24" /s /q
rmdir "Objects - TCPIP Google PowerMeter WiFi Demo App-PIC32MX3" /s /q
rmdir "Objects - TCPIP Google PowerMeter Demo App-PIC32MX3" /s /q
rmdir "Objects - TCPIP Google PowerMeter WiFi Demo App-PIC32MX4" /s /q
rmdir "Objects - TCPIP Google PowerMeter Demo App-PIC32MX4" /s /q
