...
//		}
		...
		memset(gPowerMeterPreferences.pKeyHashes[0], 0x00, 20);
		memset(gPowerMeterPreferences.pKeyHashes[1], 0x00, 20);
		memset(gPowerMeterPreferences.pKeyHashes[2], 0x00, 20);
