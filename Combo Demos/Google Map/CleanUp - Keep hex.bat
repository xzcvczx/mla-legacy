...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - Google Map - C30 - PIC24FJ256DA210_DEV_BOARD_ENC28J60" /s /q
rmdir "Objects - Google Map - C30 - PIC24FJ256DA210_DEV_BOARD_ENC624J600" /s /q
rmdir "Objects - Google Map - C30 - PIC24FJ256DA210_DEV_BOARD_MRF24WB0M" /s /q
rmdir "Objects - Google Map - C32 - PIC32_ENET_SK_DM320004_INTERNAL_ETHERNET" /s /q
rmdir "Objects - Google Map - C32 - PIC32_STARTER_KIT_MRF24WB0M" /s /q
