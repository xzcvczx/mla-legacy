...
********************************************************************/
       ...
       #ifndef USE_SST39LF400						   // if parallel flash is not used
              #define       USE_SST25VF016             // use the SPI Flash by default
       #endif
       #define       USE_RESISTIVE_TOUCH               // use the resistive touch by default
#endif

#ifdef GFX_PICTAIL_V2
       #define       USE_25LC256                       // use the SPI Flash on Explorer 16 by default
       #define       USE_SST39VF040                    // use the parallel on GFX Board by default
       #define       USE_RESISTIVE_TOUCH               // use the resistive touch by default
#endif
...
// ADC channel constants
     ...
     */
        ...
        #if defined(__USB) && !defined (PIC32_USB_SK_DM320003_1) && !defined (PIC32_ENET_SK_DM320004)
...
typedef enum
{
    ...
    HW_BUTTON_RELEASE = 1
        ...
        #define GetHWButtonProgram()        (PORTGbits.RG8)
