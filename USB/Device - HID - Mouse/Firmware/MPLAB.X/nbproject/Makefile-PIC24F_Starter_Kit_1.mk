...
${OBJECTDIR}/_ext/1472/mouse.o: ../mouse.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -omf=elf -x c -c -mcpu=24FJ256GB106 -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1472/mouse.o.d -o ${OBJECTDIR}/_ext/1472/mouse.o ../mouse.c 
...
${OBJECTDIR}/_ext/1472/mouse.o: ../mouse.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${RM} ${OBJECTDIR}/_ext/1472/mouse.o.d 
	${MP_CC}  -omf=elf -x c -c -mcpu=24FJ256GB106 -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1472/mouse.o.d -o ${OBJECTDIR}/_ext/1472/mouse.o ../mouse.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\"//g' -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1472/mouse.o.d > ${OBJECTDIR}/_ext/1472/mouse.o.tmp
	${RM} ${OBJECTDIR}/_ext/1472/mouse.o.d 
	${CP} ${OBJECTDIR}/_ext/1472/mouse.o.tmp ${OBJECTDIR}/_ext/1472/mouse.o.d 
