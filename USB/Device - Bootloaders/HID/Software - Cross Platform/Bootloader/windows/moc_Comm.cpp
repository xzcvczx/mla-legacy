...
**
** Created: Tue Jun 14 19:03:39 2011
...
static const char qt_meta_stringdata_Comm[] = {
    "Comm\0\0newValue\0SetProgressBar(int)\0"
};

const QMetaObject Comm::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Comm,
      qt_meta_data_Comm, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Comm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Comm))
