...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/usb_descriptors.o ${OBJECTDIR}/_ext/2065199231/usb_function_generic.o ${OBJECTDIR}/_ext/926206843/usb_device.o ${OBJECTDIR}/_ext/1472/main_smallSRAM.o ${OBJECTDIR}/_ext/926206843/usb_hal_pic24.o
...
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	...
	${RM} __temp_cpp_output__
${OBJECTDIR}/_ext/1472/main_smallSRAM.o: ../main_smallSRAM.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/main_smallSRAM.o   ../main_smallSRAM.c  > ${OBJECTDIR}/_ext/1472/main_smallSRAM.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.temp ../main_smallSRAM.c __temp_cpp_output__ -D __18F14K50 -D __18CXX -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\USB\\Device\ -\ WinUSB\ -\ High\ Bandwidth\ Demo\\Firmware -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\Microchip\\Include -I C:\\MCC18\\bin/../h  -D__18F14K50
	printf "%s/" ${OBJECTDIR}/_ext/1472 > ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d
else
	cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.temp >> ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d
endif
	${RM} __temp_cpp_output__
...
${OBJECTDIR}/_ext/1472/main_smallSRAM.o: ../main_smallSRAM.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/main_smallSRAM.o   ../main_smallSRAM.c  > ${OBJECTDIR}/_ext/1472/main_smallSRAM.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.temp ../main_smallSRAM.c __temp_cpp_output__ -D __18F14K50 -D __18CXX -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\USB\\Device\ -\ WinUSB\ -\ High\ Bandwidth\ Demo\\Firmware -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\Microchip\\Include -I C:\\MCC18\\bin/../h  -D__18F14K50
	printf "%s/" ${OBJECTDIR}/_ext/1472 > ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/1472/main_smallSRAM.o.d
...
dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.cof: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_LD} $(MP_EXTRA_LD_PRE) ../rm18f14k50.lkr   -w -x   -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_REAL_ICE=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -odist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.cof ${OBJECTFILES}      
else
dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.cof: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) ../rm18f14k50.lkr   -w    -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -odist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.cof ${OBJECTFILES}      
endif
