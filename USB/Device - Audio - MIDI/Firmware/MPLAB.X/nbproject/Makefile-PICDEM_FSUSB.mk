...
${OBJECTDIR}/_ext/2108320322/usb_function_audio.o: ../../../../Microchip/USB/Audio\ Device\ Driver/usb_function_audio.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o   ../../../../Microchip/USB/Audio\ Device\ Driver/usb_function_audio.c  > ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
...
${OBJECTDIR}/_ext/2108320322/usb_function_audio.o: ../../../../Microchip/USB/Audio\ Device\ Driver/usb_function_audio.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/2108320322 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o   ../../../../Microchip/USB/Audio\ Device\ Driver/usb_function_audio.c  > ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/2108320322/usb_function_audio.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o.temp ../../../../Microchip/USB/Audio\ Device\ Driver/usb_function_audio.c __temp_cpp_output__ -D PIC18F_STARTER_KIT_1 -D __18F46J50 -D __18CXX -I D:\\MAL\ May\ 05\\USB\\Device\ -\ Audio\ -\ MIDI\\Firmware -I D:\\MAL\ May\ 05\\Microchip\\Include -I C:\\Program\ Files\\Microchip\\mplabc18\\v3.38\\bin/../h  -D__18F46J50
	printf "%s/" ${OBJECTDIR}/_ext/2108320322 > ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/2108320322/usb_function_audio.o.d
