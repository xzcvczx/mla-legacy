...
CP=cp 
# Macros
CND_CONF=PIC32_USB_Starter_Kit_2
...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-PIC32_USB_Starter_Kit_2.mk dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.elf
...
# Clean Targets
.clean-conf:
	${RM} -r build/PIC32_USB_Starter_Kit_2
	${RM} -r dist/PIC32_USB_Starter_Kit_2
