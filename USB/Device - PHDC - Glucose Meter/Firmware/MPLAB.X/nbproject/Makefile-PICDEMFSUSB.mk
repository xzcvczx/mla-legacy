...
${OBJECTDIR}/_ext/1472/Glucose\ Meter\ app.o: ../Glucose\ Meter\ app.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include" -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo "${OBJECTDIR}/_ext/1472/Glucose Meter app.o"   "../Glucose Meter app.c" 
...
${OBJECTDIR}/_ext/1472/Glucose\ Meter\ app.o: ../Glucose\ Meter\ app.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/Glucose\ Meter\ app.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include" -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo "${OBJECTDIR}/_ext/1472/Glucose Meter app.o"   "../Glucose Meter app.c" 
	@${DEP_GEN} -d "${OBJECTDIR}/_ext/1472/Glucose Meter app.o" 
