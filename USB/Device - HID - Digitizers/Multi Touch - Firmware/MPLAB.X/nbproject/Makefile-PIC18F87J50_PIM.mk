...
${OBJECTDIR}/_ext/1472/MultiTouch.o: ../MultiTouch.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/MultiTouch.o   ../MultiTouch.c  > ${OBJECTDIR}/_ext/1472/MultiTouch.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/MultiTouch.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/MultiTouch.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
...
${OBJECTDIR}/_ext/1472/MultiTouch.o: ../MultiTouch.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I".." -I"../../../../Microchip/Include"  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/MultiTouch.o   ../MultiTouch.c  > ${OBJECTDIR}/_ext/1472/MultiTouch.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/MultiTouch.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/MultiTouch.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/1472/MultiTouch.o.temp ../MultiTouch.c __temp_cpp_output__ -D __18F87J50 -D __18CXX -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\USB\\Device\ -\ HID\ -\ Digitizers\\Multi\ Touch\ -\ Firmware -I C:\\flowerd\\MAL\ testing\\App\ Libs\ v2011-06\\Microchip\ Solutions\\Microchip\\Include -I C:\\MCC18\\bin/../h  -D__18F87J50
	printf "%s/" ${OBJECTDIR}/_ext/1472 > ${OBJECTDIR}/_ext/1472/MultiTouch.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/1472/MultiTouch.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/1472/MultiTouch.o.d
