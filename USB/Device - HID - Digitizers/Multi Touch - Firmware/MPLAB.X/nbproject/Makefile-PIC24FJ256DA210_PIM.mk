...
${OBJECTDIR}/_ext/1472/MultiTouch.o: ../MultiTouch.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -fno-short-double -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1472/MultiTouch.o.d -o ${OBJECTDIR}/_ext/1472/MultiTouch.o ../MultiTouch.c  
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@sed -e 's/\"//g' -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1472/MultiTouch.o.d > ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${CP} ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp}
else 
	@sed -e 's/\"//g' ${OBJECTDIR}/_ext/1472/MultiTouch.o.d > ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${CP} ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp
endif
...
${OBJECTDIR}/_ext/1472/MultiTouch.o: ../MultiTouch.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -fno-short-double -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1472/MultiTouch.o.d -o ${OBJECTDIR}/_ext/1472/MultiTouch.o ../MultiTouch.c  
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@sed -e 's/\"//g' -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1472/MultiTouch.o.d > ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp
	${RM} ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
	${CP} ${OBJECTDIR}/_ext/1472/MultiTouch.o.tmp ${OBJECTDIR}/_ext/1472/MultiTouch.o.d 
