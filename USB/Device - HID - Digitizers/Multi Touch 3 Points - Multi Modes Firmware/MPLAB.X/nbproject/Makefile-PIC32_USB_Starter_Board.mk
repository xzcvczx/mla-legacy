...
${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o: ../../Multi\ Touch\ 2\ Points\ -\ Multi\ Modes\ Firmware/MultiTouch_MultiModes.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -x c -c -mprocessor=32MX460F512L -DPIC32_USB_STARTER_KIT -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d -o ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o ../../Multi\ Touch\ 2\ Points\ -\ Multi\ Modes\ Firmware/MultiTouch_MultiModes.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d > ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.tmp
	${RM} ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d 
...
${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o: ../../Multi\ Touch\ 2\ Points\ -\ Multi\ Modes\ Firmware/MultiTouch_MultiModes.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR}/_ext/1256922932 
	${RM} ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d 
	${MP_CC}  -x c -c -mprocessor=32MX460F512L -DPIC32_USB_STARTER_KIT -I".." -I"../../../../Microchip/Include" -MMD -MF ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d -o ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o ../../Multi\ Touch\ 2\ Points\ -\ Multi\ Modes\ Firmware/MultiTouch_MultiModes.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d > ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.tmp
	${RM} ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d 
	${CP} ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.tmp ${OBJECTDIR}/_ext/1256922932/MultiTouch_MultiModes.o.d 
