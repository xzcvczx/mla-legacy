/*****************************************************************************
* FileName:         mTouchCap_PIC32MX_4ChSliderDemo.c
* Dependencies:
* Processor:        PIC32
* Compiler:         C32
* Linker:           MPLAB LINK32
...
#include    "mTouchCap_PIC32MX_4ChSliderDemo.h"

/** External Variables **/
// from \PIC32MX CVD Library\mTouchCap_CvdAPI.c
extern UINT8 dataReadyCVD;
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if(dataReadyCVD == 1)  //This flag is set by Timer ISR when all channels have been read
        {
            ...
            ButtonStatus = mTouchCapApp_DemoFourChannelSlider();
...
#          if defined( UART_DUMP_RAW_COUNTS ) || defined( UART_DUMP_ALL_COUNTS )
            {
                sprintf(ButtonMeasString,
                        "%05d,%05d,%05d,%05d,%05d,%05d\r\n",
                        iHF_Read+1,ButtonStatus,
...
// The mTouch GUI can handle up to 12 channels.  This report provides, for the
// first six buttons, the current button measurement along with the average
// measurement used to determine when a button is asserted.

//          sprintf(ButtonMeasString,
//                  "%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d\r\n",
//                  0,
//                  ButtonStatus,
