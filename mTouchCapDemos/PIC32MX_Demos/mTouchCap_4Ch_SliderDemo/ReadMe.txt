...
*******************************************************************************
                            Release Information
*******************************************************************************
mTouch Cap Library v1.21:                 Dec-2010
...
4) User should verify and modify the ADC module configuration bits when device is 
   ...
   "mTouchCap_PIC24_CTMU_Physical.h" file defines the configurations related to 
...
Step 1:   In mTouchCap_PIC24F_4ChSliderDemo.c, call the function 
          "mTouchCapApp_CreateFourChannelSlider". This function definition is written 
          in  mTouchCap_4Ch_Slider.c. Within the function, we have 4-Channel slider
          set-up function called "mTouchCapAPI_SetUpChannelSlider4Ch". 
          Before using this function, first create an objects for Slider4Ch structure.

                E.g.  a) Slider4Ch Volume.
                      b) Slider4Ch Volume1.

Step 2:  In the function mTouchCapAPI_SetUpChannelSlider4Ch, pass the first 
         parameter as Address of instance created using the Slider4Ch structure. 
...
Step 3: Pass the CTMU Channel numbers used by the specified 2-Channel Slider as next parameters.
           ...
           The aliasing for the channel definition of FOUR_CH_SLIDER1_CHANNEL0,
           FOUR_CH_SLIDER1_CHANNEL1, FOUR_CH_SLIDER1_CHANNEL2 and FOUR_CH_SLIDER1_CHANNEL3,
           is defined in HardwareProfile.h.
...
Step 6:  After the set-up function is called, call "mTouchCapApp_DemoFourChannelSlider"
         function from mTouchCap_PIC24F_4ChSliderDemo.c, which is defined in 
         mTouchCap_4Ch_Slider.c.

Step 7:  Within the  "mTouchCapApp_DemoFourChannelSlider" function, call the API 
         "mTouchCapAPI_GetStatusSlider4Ch" by passing the address of instance created
         using the Slider4Ch structure to get the percentage level of touch on Slider 
         mentioned.
...
This demo uses 4 CVD channels to perform a slider functionality. 
...
C:\Microchip Solutions\mTouchCapDemos\PIC32MX_Demos\mTouchCap_4Ch_SliderDemo
