 ...
 *******************************************************************/
 ...
 void mTouchCapApp_CreateDirectKeys(void)
 {
     ...
     mTouchCapAPI_SetUpChannelDirectKey(&DirectKey1,DIRECTKEY1_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);	
	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey2,DIRECTKEY2_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);	

	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey3,DIRECTKEY3_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);	
	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey4,DIRECTKEY4_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);	    

	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey5,DIRECTKEY5_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);	        
	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey6,DIRECTKEY6_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);
	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey7,DIRECTKEY7_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);
	 mTouchCapAPI_SetUpChannelDirectKey(&DirectKey8,DIRECTKEY8_CHANNEL,DEFAULT_TRIP_VALUE,DECODE_METHOD_PRESS_ASSERT,FILTER_METHOD_GATEDAVERAGE);
