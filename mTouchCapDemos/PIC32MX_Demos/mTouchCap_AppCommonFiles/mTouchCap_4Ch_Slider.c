...
*   UINT16 mTouchCapApp_DemoFourChannelSlider(void)
...
#include    "mTouchCap_CvdAPI.h" //goes before "mTouchCap_4Ch_Slider.h"
...
// from PIC32MX CVD Library\mTouchCap_CvdAPI.c(94)
