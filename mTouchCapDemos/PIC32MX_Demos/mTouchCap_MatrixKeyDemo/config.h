...
#define    	NUM_HF_READS     	    	16	 // number of reads in CVD channel
...
#define		HYSTERESIS_VALUE			4		// This is the minimum value which determines untouched condition

#define 	NUM_AVG						80		// Defines frequency of average update
