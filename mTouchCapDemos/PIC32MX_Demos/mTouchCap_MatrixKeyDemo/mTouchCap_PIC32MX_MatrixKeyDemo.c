...
#include    "mTouchCap_PIC32MX_MatrixKeyDemo.h"
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if(dataReadyCVD == 1)  //This flag is set by Timer ISR when all channels have been read
        {
            ...
            CurrentButtonStatus = mTouchCapApp_DemoMatrixKeys();
...
#          if defined( UART_DUMP_RAW_COUNTS ) || defined( UART_DUMP_ALL_COUNTS )
            {
                sprintf(ButtonMeasString,
                        "%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d,%05d\r\n",
                        iHF_Read+1,CurrentButtonStatus,CurrentButtonAsserts,
