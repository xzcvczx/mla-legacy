...
Step 1:   In mTouchCap_PIC24F_MatrixKeyDemo.c, call the function "mTouchCapApp_CreateMatrixKeys". 
...
Step 6:  After the set-up function is called, call "mTouchCapApp_DemoMatrixKeys" function from 					mTouchCap_PIC24F_MatrixKeyDemo.c, which is defined in mTouchCap_MatrixKeys.c.
