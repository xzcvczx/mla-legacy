...
extern WORD	curRawData		[24];	//Storage for CTMU channel values
extern WORD	tripValue   		[24];	//Storage for the trip point for each channel	
extern WORD	hystValue   		[24];	//Storage for the hysterisis value for each channel
extern WORD	pressedCount   	[24];	//Storage for count of pressed value for each channel
extern WORD	unpressedCount  [24];	//Storage for count of unpressed value for each channel
extern WORD	avg_delay 		[24];//Storage for count for average update for each channel	
extern WORD	averageData 	[24];	// running average of CTMU channels	
extern WORD	smallAvg		[24];	// current button smallavg
extern WORD	actualValue		[24];	// actual raw A/D counts for each channel
extern WORD	channel_TRIM_value	[24];
extern WORD	channel_IRNG_value	[24];
extern BYTE	chFilterType	[24];	// Channel filter type
extern BYTE	chDecodeMethod	[24];	// decode method type
...
Remarks     : None.
**************************************************************************/
#define Adc_PortA_Configuration(Value)	(ANSA = ANSA & Value)
#define Adc_PortB_Configuration(Value)	(ANSB = ANSB & Value)
#define Adc_PortC_Configuration(Value)	(ANSC = ANSC & Value)
#define Adc_PortD_Configuration(Value)	(ANSD = ANSD & Value)
#define Adc_PortE_Configuration(Value)	(ANSE = ANSE & Value)
#define Adc_PortF_Configuration(Value)	(ANSF = ANSF & Value)
#define Adc_PortG_Configuration(Value)	(ANSG = ANSG & Value)
...
//#define ADC_PORTA_CONFIG_DEFAULT_VALUE 	0x0000			// Default Value of ADC Port Configuration Register.
#define ADC_PORTB_CONFIG_DEFAULT_VALUE 	0x0020
//#define ADC_PORTC_CONFIG_DEFAULT_VALUE 	0x0000
//#define ADC_PORTD_CONFIG_DEFAULT_VALUE 	0x0000
#define ADC_PORTE_CONFIG_DEFAULT_VALUE 	0x0200
//#define ADC_PORTF_CONFIG_DEFAULT_VALUE 	0x0000
#define ADC_PORTG_CONFIG_DEFAULT_VALUE 	0x0100
