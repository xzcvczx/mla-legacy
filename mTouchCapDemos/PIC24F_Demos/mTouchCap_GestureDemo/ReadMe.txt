...
boards(DM183026). The Gesture Demo uses the Direct Key plug-in board. 
...
Note : Since the Gesture Demo uses the Direct key board, all the instructions related to the DirectKey demo applies to Gesture demo as well. 
*******************************************************************************
1) mTouchCap_GestureDemo project can be configured as per user's application by
...
Step 6:  After the set-up function is called, call "mTouchCapApp_DemoDirectKeys" function from 					mTouchCap_PIC24F_DirectKeyDemo.c, which is defined in mTouchCap_DirectKeys.c.

Step 7:  Within the  "mTouchCapApp_DemoDirectKeys" function, call the API "mTouchCapAPI_GetStatusDirectButton" by passing the address of 	instance created using the "DirectKey" structure to get the information about touch on Directkey Pad.
...
C:\Microchip Solutions\mTouchCapDemos\PIC24F_Demos\mTouchCap_GestureDemo
