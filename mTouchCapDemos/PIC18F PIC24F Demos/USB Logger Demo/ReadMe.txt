...
Compiler Version:                 C18 3.40 or Later, C30 3.31 or Later
...
"...\mTouchCapDemos\Utilities\PIC18F PIC24F Tools\Pickit Serial Loader".

The demo works with mTouch GUI utility "mTouch GUI.exe" located in 
"...\mTouchCapDemos\Utilities\PIC18F PIC24F Tools\mTouch GUI".
Please read "mTouch GUI Help.chm" to get started.
...
*******************************************************************************
Only MPLAB C18 and MPLAB C30 compilers are supported for this demo.
