...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1595192242/mTouchAcquistion.o ${OBJECTDIR}/_ext/1595192242/mTouchButton.o ${OBJECTDIR}/_ext/1595192242/mTouchControl.o ${OBJECTDIR}/_ext/1595192242/mTouchSensor.o ${OBJECTDIR}/_ext/865876355/system.o ${OBJECTDIR}/_ext/1595192242/mTouchDebug.o ${OBJECTDIR}/_ext/1472/Button\ Demo\ Main.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/Button\ Demo\ Main.o: ../Button\ Demo\ Main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/Button\ Demo\ Main.o.ok ${OBJECTDIR}/_ext/1472/Button\ Demo\ Main.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/Button Demo Main.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -I".." -I"../../../../Microchip/Include" -I"../../Configurations/PIC24F_mTouch_Eval_Board" -I"../../../../Microchip/Include/mTouchCap/PIC18F PIC24F Library" -Os -MMD -MF "${OBJECTDIR}/_ext/1472/Button Demo Main.o.d" -o "${OBJECTDIR}/_ext/1472/Button Demo Main.o" "../Button Demo Main.c"  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-Map="${DISTDIR}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-Map="${DISTDIR}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Button_Demo_PIC24F.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=elf
endif
