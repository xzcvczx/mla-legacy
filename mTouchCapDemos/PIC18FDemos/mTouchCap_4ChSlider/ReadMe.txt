...
1) mTouchCap_4Ch_Slider project can be configured as per user's application by
...
Step 1: In mTouchCap_PIC18F_4ChSliderDemo.c, call the function "mTouchCapApp_CreateFourChannelSlider". 
           This function definition is written in  mTouchCap_4Ch_Slider.c. Within the function, we have 4-Channel
           slider set-up function called mTouchCapAPI_SetUpChannelSlider4Ch. Before using this function, 
           first create an objects for Slider4Ch structure.
...
Step 6: After the set-up function is called, call "mTouchCapApp_DemoFourChannelSlider" function from
           mTouchCap_PIC18F_4ChSliderDemo.c, which is defined in mTouchCap_4Ch_Slider.c.

Step 7: Within the  "mTouchCapApp_DemoFourChannelSlider" function, call the API "mTouchCapAPI_GetStatusSlider4Ch" 
           by passing the address of instance created using the Slider4Ch structure to get the percentage level of touch 
           on Slider mentioned.
...
C:\Microchip Solutions v2011-06-02\mTouchCapDemos\PIC18FDemos\mTouchCap_4Ch_Slider
...
1) User is requested to see the availability of port pins in the devices and initialize them accordingly in 
    C:\Microchip Solutions\mTouchCapDemos\PIC18FDemos\mTouchCap_4ChSliderDemo.c
