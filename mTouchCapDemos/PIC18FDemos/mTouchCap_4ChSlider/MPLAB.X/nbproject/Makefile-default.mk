...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/274675202/mTouchCap_Timers.o ${OBJECTDIR}/_ext/274675202/mTouchCap_PIC18_CTMU_Physical.o ${OBJECTDIR}/_ext/1907416406/mTouchCap_4Ch_Slider.o ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o ${OBJECTDIR}/_ext/1907416406/Display.o ${OBJECTDIR}/_ext/274675202/mTouchCap_Adc.o ${OBJECTDIR}/_ext/274675202/mTouchCap_CtmuAPI.o
...
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	...
	${RM} __temp_cpp_output__
${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o: ../mTouchCap_PIC18F_4ChSliderDemo.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) -I"../../mTouchCap_AppCommonFiles" -I"../../../../Microchip/Include/mTouchCap/PIC18F_PIC24F CTMU Library" -I"../../../../Microchip/Include" -I".." -ou- -ot- -ob- -op- -or- -od- -opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o   ../mTouchCap_PIC18F_4ChSliderDemo.c  > ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.temp ../mTouchCap_PIC18F_4ChSliderDemo.c __temp_cpp_output__ -D __18F46J50 -D __18CXX -I C:\\Microchip\ Solutions\\mTouchCapDemos\\PIC18FDemos\\mTouchCap_AppCommonFiles -I C:\\Microchip\ Solutions\\Microchip\\Include\\mTouchCap\\PIC18F_PIC24F\ CTMU\ Library -I C:\\Microchip\ Solutions\\Microchip\\Include -I C:\\Microchip\ Solutions\\mTouchCapDemos\\PIC18FDemos\\mTouchCap_4ChSlider -I C:\\Program\ Files\\Microchip\\mplabc18\\v3.38\\bin/../h  -D__18F46J50
	printf "%s/" ${OBJECTDIR}/_ext/1472 > ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d
else
	cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.temp >> ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d
endif
	${RM} __temp_cpp_output__
...
${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o: ../mTouchCap_PIC18F_4ChSliderDemo.c  nbproject/Makefile-${CND_CONF}.mk
	${RM} ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d 
	${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"../../mTouchCap_AppCommonFiles" -I"../../../../Microchip/Include/mTouchCap/PIC18F_PIC24F CTMU Library" -I"../../../../Microchip/Include" -I".." -ou- -ot- -ob- -op- -or- -od- -opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o   ../mTouchCap_PIC18F_4ChSliderDemo.c  > ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err 2>&1 ; if [ $$? -eq 0 ] ; then cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err | sed 's/\(^.*:.*:\)\(Warning\)\(.*$$\)/\1 \2:\3/g' ; else cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.err | sed 's/\(^.*:.*:\)\(Error\)\(.*$$\)/\1 \2:\3/g' ; exit 1 ; fi
	${MP_CPP}  -MMD ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.temp ../mTouchCap_PIC18F_4ChSliderDemo.c __temp_cpp_output__ -D __18F46J50 -D __18CXX -I C:\\Microchip\ Solutions\\mTouchCapDemos\\PIC18FDemos\\mTouchCap_AppCommonFiles -I C:\\Microchip\ Solutions\\Microchip\\Include\\mTouchCap\\PIC18F_PIC24F\ CTMU\ Library -I C:\\Microchip\ Solutions\\Microchip\\Include -I C:\\Microchip\ Solutions\\mTouchCapDemos\\PIC18FDemos\\mTouchCap_4ChSlider -I C:\\Program\ Files\\Microchip\\mplabc18\\v3.38\\bin/../h  -D__18F46J50
	printf "%s/" ${OBJECTDIR}/_ext/1472 > ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT)))
	cat ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.temp | sed -e 's/\\\ /__SPACES__/g' -e's/\\$$/__EOL__/g' -e 's/\\/\//g' -e 's/__SPACES__/\\\ /g' -e 's/__EOL__/\\/g' >> ${OBJECTDIR}/_ext/1472/mTouchCap_PIC18F_4ChSliderDemo.o.d
