...
////////////////////////////////////////////////////////////////////////////////
	...
	#define MATRIXKEY0_ROW_CHANNEL    		CHANNEL_AN0
	#define MATRIXKEY0_COLUMN_CHANNEL    	CHANNEL_AN6
	
	#define MATRIXKEY1_ROW_CHANNEL    		CHANNEL_AN1
	#define MATRIXKEY1_COLUMN_CHANNEL    	CHANNEL_AN6
	
	#define MATRIXKEY2_ROW_CHANNEL    		CHANNEL_AN2
	#define MATRIXKEY2_COLUMN_CHANNEL    	CHANNEL_AN6
	
	#define MATRIXKEY3_ROW_CHANNEL    		CHANNEL_AN3
	#define MATRIXKEY3_COLUMN_CHANNEL    	CHANNEL_AN6
	
	#define MATRIXKEY4_ROW_CHANNEL    		CHANNEL_AN0
	#define MATRIXKEY4_COLUMN_CHANNEL    	CHANNEL_AN5
	
	#define MATRIXKEY5_ROW_CHANNEL    		CHANNEL_AN1
	#define MATRIXKEY5_COLUMN_CHANNEL    	CHANNEL_AN5
	
	#define MATRIXKEY6_ROW_CHANNEL    		CHANNEL_AN2
	#define MATRIXKEY6_COLUMN_CHANNEL    	CHANNEL_AN5
	
	
	#define MATRIXKEY7_ROW_CHANNEL    		CHANNEL_AN3
	#define MATRIXKEY7_COLUMN_CHANNEL    	CHANNEL_AN5
	
	#define MATRIXKEY8_ROW_CHANNEL    		CHANNEL_AN0
	#define MATRIXKEY8_COLUMN_CHANNEL    	CHANNEL_AN4
	
	
	#define MATRIXKEY9_ROW_CHANNEL    		CHANNEL_AN1
	#define MATRIXKEY9_COLUMN_CHANNEL    	CHANNEL_AN4
	
	#define MATRIXKEY10_ROW_CHANNEL    		CHANNEL_AN2
	#define MATRIXKEY10_COLUMN_CHANNEL    	CHANNEL_AN4
	
	#define MATRIXKEY11_ROW_CHANNEL    		CHANNEL_AN3
	#define MATRIXKEY11_COLUMN_CHANNEL    	CHANNEL_AN4
...
#ifdef ADC_ANCON_LEGACY							//To make port pin has Digital ANCON register should be set  
	#define     MAKE_ALL_DIGITAL_PINS  	0xFF
#else
	#define     MAKE_ALL_DIGITAL_PINS  	0x00
#endif
