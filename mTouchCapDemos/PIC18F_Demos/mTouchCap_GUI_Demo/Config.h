...
/************************************************************************************
*Enable the macro when the external stand alone GUI is used.
*If the MPLAB mTouch Diagnostic tool is used, this macro should be disabled
************************************************************************************/

//#define MTOUCH_STANDALONE_GUI
