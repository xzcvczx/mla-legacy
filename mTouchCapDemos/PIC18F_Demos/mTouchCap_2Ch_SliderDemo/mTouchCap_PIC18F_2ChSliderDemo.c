...
/*****************************************************************************
 * FileName:        	mTouchCap_PIC18F_2ChSliderDemo.c
 * Dependencies:
 * Processor:       	PIC18
 * Compiler:       		C18
 * Linker:          	MPLINK
...
#include	"Config.h"
#include	"mTouchCap_PIC18F_2ChSliderDemo.h"
...
//If the selected device is PIC18F46J50, then apply below settings. User can edit this as per requirement.
...
//If the selected device is PIC18F46J11, then apply below settings. User can edit this as per requirement.
#if defined(__18F46J11) || defined(__18F45J11) || defined(__18F44J11) || defined(__18F26J11)
#pragma config WDTEN = OFF, XINST = OFF
#pragma config OSC=HSPLL, DSBOREN = OFF, DSWDTEN = OFF, IOL1WAY = OFF 
#endif


#if defined(__18F87J90) || defined(__18F87J93) || defined(__18F66J90) || defined(__18F87J92)
#pragma config WDTEN = OFF, XINST = OFF
#pragma config OSC=HSPLL, DSBOREN = OFF, DSWDTEN = OFF, IOL1WAY = OFF 
#endif
