...
Step 7:  Within the  "mTouchCapApp_DemoTwoChannelSlider" function, call the API mTouchCapAPI_GetStatusSlider2Ch by passing the 			address of instance created using the Slider2Ch structure to get the percentage level of touch on selected slider.
...
C:\Microchip Solutions\mTouchCapDemos\PIC18F_Demos\mTouchCap_2Ch_SliderDemo
