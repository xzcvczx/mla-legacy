...
//If the selected device is as mentioned below, then apply below settings. User can edit this as per requirement.
#elif defined(__PIC24F08KA101__) || defined(__PIC24F08KA102__) || defined(__PIC24F16KA101__ )\
...
//If the selected device is as mentioned below, then apply below settings. User can edit this as per requirement.
#elif defined(__PIC24FJ32GA102__) || defined(__PIC24FJ32GA104__)\
...
//If the selected device is as mentioned below, then apply below settings. User can edit this as per requirement.
#elif defined(__PIC24FJ32GB002__) || defined(__PIC24FJ32GB004__)\
...
//If the selected device is as mentioned below, then apply below settings. User can edit this as per requirement.
#elif defined(__PIC24FJ128GA106__)|| defined(__PIC24FJ128GA108__) || defined(__PIC24FJ128GA110__)\
...
//If the selected device is as mentioned below, then apply below settings. User can edit this as per requirement.
#elif defined(__PIC24FJ128GB206__) || defined (__PIC24FJ128GB210__)\
