...
1) mTouchCap_LowPower project can be configured as per user's application by
...
*******************************************************************************
The purpose of the Low Power Demo is to demonstrate the functionality of implementing a Low Power 
application using the Direct Key Demo board. 
...
The entire logic for the power saving method is implemented within a demo function called 
mTouchCapApp_LowPower_Process().The entire logic is implemented within the macro LOW_POWER_DEMO_ENABLE. 
...
C:\Microchip Solutions v2011-06-02\mTouchCapDemos\PIC24FDemos\mTouchCap_LowPower
...
C:\Microchip Solutions v2011-06-02\mTouchCapDemos\PIC24FDemos\mTouchCap_LowPower.c
