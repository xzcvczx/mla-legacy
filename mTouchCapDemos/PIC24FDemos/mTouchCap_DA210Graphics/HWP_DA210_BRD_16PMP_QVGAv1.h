 ...
 *
 *********************************************************************
 * FileName:        HWP_DA210_BRD_16PMP_QVGAv1.h
 * Processor:       PIC24F, PIC24H, dsPIC, PIC32
 * Compiler:        Microchip C32 v1.00 or higher
 *					Microchip C30 v3.25 or higher
...
*********************************************************************/
	...
	// optimum (fastest) timing requirement for your interface. 
        ...
        #define PMP_DATA_WAIT_TIME                 (10)  // See Epson S1D13517 data sheet for details
        #define PMP_DATA_HOLD_TIME                 (0)    
...
*/
    ...
    */
    ...
    // Chip Select, SCLK, SDI and SDO signals used 
	    	...
	    	#define SST25_CS_ANS    ANSELDbits.ANSD1    // SPI slave select I/O pin analog/digital selection.
