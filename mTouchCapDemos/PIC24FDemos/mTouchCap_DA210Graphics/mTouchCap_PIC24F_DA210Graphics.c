 ...
 *****************************************************************************
 * FileName:        mTouchCap_PIC24F_DA210Graphics.c
 * Dependencies:    mTouchCap_PIC24F_DA210Graphics.h
 ...
 * Author               Date        Comment
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Bruce Bohn			01/17/2010  Initial Release
 * Nithin M				05/24/2011  Incorporating the updated Graphics Library
 *****************************************************************************/
#include "mTouchCap_CtmuAPI.h"
//#include "mTouchCap_PIC24_CTMU_Physical.h"
#include "mTouchCap_PIC24F_DA210Graphics.h"
...
//                              OBJECT DIMENSIONS
/////////////////////////////////////////////////////////////////////////////
#define SLDR_XSTART		23
#define SLDR_YSTART		105
#define SLDR_WIDTH		(GetMaxX()-47)
...
//    pMsg->uiEvent = EVENT_INVALID;
	...
	switch(padState)
	{
		...
		{
			pMsg->param1  = SLDR_XSTART+SLDR_WIDTH - 3;
		    pMsg->param2  = SLDR_YSTART+(SLDR_HEIGHT/2);
			pMsg->uiEvent = EVENT_RELEASE;
			pMsg->type = TYPE_TOUCHSCREEN;
			padState = IDLE;
...
//			SwitchIOADCVals();
		if(mTouchChCount >= 2)
		{
			...
			/* Scans the CTMU channel for ADC voltage. It updates the "curRawData" and "actualValue" buffers. */
	   		mTouchCapPhy_ReadCTMU(ScanChannels[mTouchChCount]);  
			
			/* Periodically average the channel data based on User configuration. */
			mTouchCapPhy_AverageData(ScanChannels[mTouchChCount]); 		
