...
*******************************************************************************
1) The GUI demos will work only with the "Custom" option selected from the "Select Board" drop down 
menu in the "Settings" tab in the MPLAB mTouch Diagnostic Tool.
...
C:\Microchip Solutions v2011-06-02\mTouchCapDemos\PIC24FDemos\mTouchCap_GUI
