...
#define 	DEBOUNCECOUNT				6		// Defines How Many consecutive reads for
...
#define    NUM_HF_READS     	    		3	 // number of reads in CTMU channel read routine 64 --> 10 
                                            				// each read takes 12uS. 1ms timeslice max.

/* PIC 24F related constants */
#define	KEYTRIPDIV			    		9 		// the divisors define the trip points for
