	...
	***************************************************************************/
	...
	while(1)
	{
		...
		if(dataReadyCTMU == 1)			// This flag is set by Timer 4 ISR //when all channels have been read
		{
			...
			***************************************************************************/
			mTouchCapAPI_SetUpChannel (SLDR2CHNL1, DEFAULT_TRIP_VALUE, DECODE_METHOD_PRESS_AND_RELEASE, FILTER_METHOD_1BY20);
			mTouchCapAPI_SetUpChannel (SLDR2CHNL2, DEFAULT_TRIP_VALUE, DECODE_METHOD_PRESS_AND_RELEASE, FILTER_METHOD_1BY20);
			#endif
