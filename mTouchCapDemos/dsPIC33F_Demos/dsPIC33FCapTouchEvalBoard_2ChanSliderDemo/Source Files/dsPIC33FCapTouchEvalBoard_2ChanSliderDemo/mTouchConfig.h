...
/* ~~~~~~~~~~~~~~~~~~~~~    Timer Call Back  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
  #define TIMERCALLBACKFUNC TimerCallbackFunc0
...
#define  MAX_SLIDER_DELTA        8   // Max # counts (out of 256) between slider value updates
/* Debug count for key press */
#define DEBOUNCECOUNT            3   // Defines How Many consecutive reads for

#define TIMER4_PERIOD         1000  // Timer4 clock ticks between button scans

#define NUM_HF_READS             8  // number of reads in CVD Channels
