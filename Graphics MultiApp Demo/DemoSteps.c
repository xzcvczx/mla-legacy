...
const DEMO_MSG  DemoPoints[] =  {   // dummy event
    ...
    {TYPE_TOUCHSCREEN, EVENT_PRESS,   CtrlBtnLeft(3)+2, CtrlBtnTop()+2, THIRTYSECDELAY},
    {TYPE_TOUCHSCREEN, EVENT_RELEASE, CtrlBtnLeft(3)+2, CtrlBtnTop()+2, HALFSECDELAY},
    ...
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+2, PLTYPOS+2, HALFSECDELAY},
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+4, PLTYPOS+2, FIFTHSECDELAY},
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+8, PLTYPOS+2, FIFTHSECDELAY},
    ...
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+8, PLTYPOS+2, FIFTHSECDELAY},
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+4, PLTYPOS+2, FIFTHSECDELAY},
    {TYPE_TOUCHSCREEN, EVENT_PRESS, PLTXPOS+2, PLTYPOS+2, FIFTHSECDELAY},
