/********************************************************************
 FileName:     	HardwareProfile - GMAP PIC24FJ256GA110 PIM.h
 Dependencies:  See INCLUDES section
 Processor:     PIC24FJ256GA110
 Hardware:      PIC24FJ256GA110 PIM
...
#ifndef HARDWARE_PROFILE_GMAP_PIC24FJ256GA110_PIM_H
#define HARDWARE_PROFILE_GMAP_PIC24FJ256GA110_PIM_H
...
* For PIC24FJ256GA110 - use SPI2 since there is an IO problem with SPI1
*********************************************************************/
#define USESDCARDPICTAILSPI2			// Connect SD PICtail Plus to SPI2 
 ...
 * For PIC24FJ256GA110 Use SPI1 only. SPI2 pins in PICtail Plus is
 * used by USB.
 ********************************************************************* 
*********************************************************************/
...
#if defined(USESDCARDPICTAILSPI2)
...
#else
	#error SPI1 Cannot be used in PIC24FJ256GA110 because of IO problem
#endif
...
#endif  //HARDWARE_PROFILE_GMAP_PIC24FJ256GA110_PIM_H
