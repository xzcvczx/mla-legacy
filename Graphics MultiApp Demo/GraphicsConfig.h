...
*                                        
********************************************************************/
//#define GRAPHICS_PICTAIL_VERSION       250
...
//#define GRAPHICS_PICTAIL_VERSION       2
	...
	#if defined (ENABLE_USB_MSD_DEMO) || defined (ENABLE_USB_HOST_HID_DEMO)
		#error This Demo with USB enabled cannot run on Graphics PICtail Version2 that is not modified using TB3012 instructions!
