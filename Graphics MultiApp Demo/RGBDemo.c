...
/************************************************************************
 ...
 Overview: This function that monitors the hardware HID device connection.
...
/************************************************************************
 ...
 Overview: Loads the current RGB colors into the lightdata buffer for
...
/************************************************************************
 Function: void UpdateLightData(void)
  
 Overview: Writes the contents of the lightdata buffer to the HID 
 		   device.
...
/************************************************************************
 Function: BOOL AppGetParsedReportDetails(void)
  
 Overview: USB support function that updates the report buffer.
...
/************************************************************************
 ...
 Overview: This function is empty if hardware is not used when 
 		   this demo is compiled.
