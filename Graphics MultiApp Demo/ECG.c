...
#define ECG_PANEL_TOP    			5
#define ECG_PANEL_BOTTOM 			138

#define ECG_X_TEXT      			ECG_PANEL_LEFT+40
#define ECG_X_DIM       			ECG_PANEL_RIGHT-50
    ...
    switch(ecgStates){
        ...
        case ECG_MEASURE:
            ...
            if(label<2){
                ...
                ECGDrawArrow(GR_LEFT+ecgHorX1, (ECG_PANEL_TOP+ECG_PANEL_BOTTOM)>>1,
                         GR_LEFT+ecgHorX2, (ECG_PANEL_TOP+ECG_PANEL_BOTTOM)>>1);
                ECGDrawArrow(ECG_ARROW_SIZE+GR_LEFT+ecgVerX1, GR_TOP+ecgVerY1,
                         ECG_ARROW_SIZE+GR_LEFT+ecgVerX1, GR_TOP+ecgVerY2);
...
WORD  temp;
    ...
    {
        temp = ecgVerY1; ecgVerY1 = ecgVerY2; ecgVerY2 = temp;
        temp = ecgVerX1; ecgVerX1 = ecgVerX2; ecgVerX2 = temp;
    }

    if(ecgHorX1 > ecgHorX2)
    {
        temp = ecgHorY1; ecgHorY1 = ecgHorY2; ecgHorY2 = temp;
        temp = ecgHorX1; ecgHorX1 = ecgHorX2; ecgHorX2 = temp;
    }
}
