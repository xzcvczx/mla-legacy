...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - TCPIP WiFi Demo App-C18" /s /q
rmdir "Objects - TCPIP WiFi Demo App-C30" /s /q
rmdir "Objects - TCPIP WiFi Demo App-C32" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WiFi Demo App-C18" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WiFi Demo App-C30" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WiFi Demo App-C32" /s /q
