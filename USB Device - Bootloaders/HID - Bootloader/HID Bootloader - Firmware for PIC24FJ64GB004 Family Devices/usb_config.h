...
#define USB_POLLING
//Interrupt mode is not currently supported (In this bootloader firmware)
//Application can use interrupts if the interrupt vector table either gets 
//remapped, or is updated by the bootloader application.
