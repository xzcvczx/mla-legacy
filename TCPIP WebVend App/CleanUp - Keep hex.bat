...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - TCPIP WebVend App- C18 - PICDEMNET2_INTERNAL_ETHERNET" /s /q
rmdir "Objects - TCPIP WebVend App- C18 - PICDEMNET2_ONBOARD_ENC28J60" /s /q
rmdir "Objects - TCPIP WebVend App- C18 - PICDEMNET2_ENC624J600" /s /q
rmdir "Objects - TCPIP WebVend App- C18 - PICDEMNET2_MRF24WB0M" /s /q
rmdir "Objects - TCPIP WebVend App- C30 - EXPLORER_16_ENC28J60" /s /q
rmdir "Objects - TCPIP WebVend App- C30 - EXPLORER_16_ENC624J600" /s /q
rmdir "Objects - TCPIP WebVend App- C30 - EXPLORER_16_MRF24WB0M" /s /q
rmdir "Objects - TCPIP WebVend App- C32 - EXPLORER_16_ENC28J60" /s /q
rmdir "Objects - TCPIP WebVend App- C32 - EXPLORER_16_ENC624J600" /s /q
rmdir "Objects - TCPIP WebVend App- C32 - EXPLORER_16_MRF24WB0M" /s /q
