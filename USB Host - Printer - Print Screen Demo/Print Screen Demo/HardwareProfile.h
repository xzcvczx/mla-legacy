...
/*********************************************************************
* SETTINGS FOR DISPLAY DRIVER FEATURE for PIC24FJ256DA210 
* display controller
*********************************************************************/
...
// Using TFT2N0369_E Display Panel
	#if (DISPLAY_PANEL == TFT2N0369_E)
		#define DISP_ORIENTATION		90
        #define DISP_HOR_RESOLUTION		240
        #define DISP_VER_RESOLUTION		320
	...
	#endif // #if (DISPLAY_PANEL == TFT2N0369_E)

// Using DT032TFT_TS or DT032TFT Display Panel
	#if (DISPLAY_PANEL == DT032TFT_TS) || (DISPLAY_PANEL == DT032TFT)
		#define DISP_ORIENTATION		90
        #define DISP_HOR_RESOLUTION		240
        #define DISP_VER_RESOLUTION		320
        #define DISP_DATA_WIDTH			18
        ...
        #define DISP_VER_BACK_PORCH     0
        #define DISP_VER_FRONT_PORCH    2
	#endif // #if (DISPLAY_PANEL == DT032TFT_TS)
...
// Using _35QVW0T Display Panel
	#if (DISPLAY_PANEL == _35QVW0T) 
		#define DISP_ORIENTATION		0
        #define DISP_HOR_RESOLUTION		320
        #define DISP_VER_RESOLUTION		240
        #define DISP_DATA_WIDTH			18
        ...
        #define DISP_VER_BACK_PORCH     7
        #define DISP_VER_FRONT_PORCH    5
	#endif // #if (DISPLAY_PANEL == _35QVW0T)
...
*********************************************************************/
	...
	#define SetSwitchDirection()    (PORTSetPinsDigitalIn(IOPORT_B, (BIT_1 | BIT_2 | BIT_3 | BIT_4)))
	#define SwitchPress(sw)         (PORTReadBits(IOPORT_B, (sw)) ^ (sw))
#else
    #if defined(__dsPIC33FJ128GP804__) || defined(__PIC24HJ128GP504__)
        #define BTN_S3  _RA9
        #define BTN_S4  1
        #define BTN_S5  1
        #define BTN_S6  1
	#elif defined (PIC32_USB_SK_DM320003_1) || defined (PIC32_USB_SK_DM320003_2) 
