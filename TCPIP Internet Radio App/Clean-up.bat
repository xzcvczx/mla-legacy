...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - Internet Radio App" /s /q
rmdir "Objects - Internet Radio App-C30" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - Internet Radio App" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - Internet Radio App-C30" /s /q
