...
*   void mTouchCapAPI_SetUpChannelSlider2Ch(SLIDER2CH *Slider,
...
UINT8  dataReadyCVD;        //global indicating the reading of all channels finished
...
/******************************************************************************
* Function: BYTE mTouchCapAPI_SetUpChannelSlider2Ch(SLIDER2CH *Slider,
*                                                    BYTE Slider_Channel1_number,
*                                                    BYTE Slider_Channel2_number,
*                                                    WORD Trip_Value,
*                                                    BYTE Decode_Method,
...
*
* Overview:
*  This API will setup the 2 channels associated with the 2-channel Slider.
*  The 2 channel numbers, filter type and decode method are stored in the
*  structure associated with the corresponding 2-Channel Slider
*:
******************************************************************************/
...
/******************************************************************************
 ...
 Overview       :
  This API gets the percentage level of a particular 2-channel slider passed.
