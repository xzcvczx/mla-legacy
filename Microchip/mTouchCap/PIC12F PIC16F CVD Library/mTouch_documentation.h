...
*     @li @ref ts-Comms   "PC Communications"</td>
* <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
*   <li> <b>/mTouchCap</b>
*       <ul>
*       <li> <b>/PIC12F PIC16F CVD Library</b><br>
...
*       @li <b>PKS_0305_FACTORY_FW.HEX</b> :: When prompted, choose this hex file if you are implementing <b>two-way communication</b>. This
...
*       or from a GUI that reads COM ports, such as the mTouch One-Way GUI.<br><br>
*       You can find the mTouch One-Way GUI in <tt>Your MLA Directory/mTouchCapDemos/Utilities/PIC12F PIC16F Utilities/mTouch One-Way GUI</tt><br><br>
*       If you wish to use the PICKit Serial with this communication type, it must be loaded with the UART-to-USB
*       firmware. See @ref PKSARS232 "this guide" for information on loading this hex file to your PKSA.<br><br>
...
*       <a href="../mComm Programmers Guide.pdf"><b>Programmer's Guide - (PDF)</b></a><br><br>
...
*   @li <b>Default PKSA Behavior</b> :: PKS_0305_FACTORY_FW.HEX :: PKSA behaves as an HID device that is manipulated through a DLL.
*
...
*
* You must load the <b>PKS_0305_FACTORY_HW.HEX</b> when requested by the loader utility. See 
