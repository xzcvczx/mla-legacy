/******************************************************************************
 ...
 ZG2100 Text Control Console: iwconfig Command
 Module for Microchip TCP/IP Stack

*******************************************************************************
 FileName:		ZGConsoleIwconfig.c
...
iwconfigSetRtsRequest(void * const ptrRequest, tZGVoidInput *appOpaquePtr)
{
  ...
  if ( appOpaquePtr == kNULL )
     ZGErrorHandler((ROM FAR char*)"SetRts");
...
#if defined ( EZ_CONFIG_SCAN )
                case kZGWaitingForScan:
                    if (startDynamicScan())
                        ZG_PUTRSUART( "Scan started...\n\r");
                    gLineParseState = kZGWaitingForParamKeyword;
                    break;
#endif /* EZ_CONFIG_SCAN */
...
#if defined ( EZ_CONFIG_SCAN )
        case kZGScanParam:
             gLineParseState = kZGWaitingForScan;
             break;
#endif  /* EZ_CONFIG_SCAN */
