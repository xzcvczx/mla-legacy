/******************************************************************************
 ...
 ZG2100 Driver Configuration Settings and Controls
...
ROM tZGS8 g_SDKVersion[] = "1.5.2.7";
...
ZGLibCfgSetRfChannelList(tZGU8Ptr channelList, tZGU8 size)
{
  ...
  {
    ZGErrorHandler((ROM FAR char*) "Selected Domain doesn't match channel table");
  }
                   ...
                   tZGU16 len, tZGVoidInput *appOpaquePtr)
{
   ...
   {
      ZGErrorHandler((ROM FAR char*) "Set TxData CFRM");
   }
