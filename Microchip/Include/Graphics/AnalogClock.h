...
/*********************************************************************
* Function: AcTranslateMsg(BUTTON *pB, GOL_MSG *pMsg)
*
...
*     	##################     ############	    #######################     ##################################################################################################################################################################
*     	AC_MSG_PRESSED        Touch Screen     EVENT_PRESS, EVENT_MOVE    	
*     					       Keyboard         EVENT_KEYSCAN  				
*		AC_MSG_STILLPRESSED   Touch Screen     EVENT_STILLPRESS								
*		AC_MSG_RELEASED	   Touch Screen     EVENT_RELEASE  									      			   
*							   Keyboard         EVENT_KEYSCAN  									      			   
*		AC_MSG_CANCELPRESS	   Touch Screen     EVENT_MOVE  										      			   
*		AC_MSG_INVALID		   Any		        Any			  										 
*	</TABLE>
*
* PreCondition: none
*
* Input: pAc    - The pointer to the object where the message will be
...
*		  - AC_MSG_PRESSED – Clock is pressed
*         - AC_MSG_RELEASED – Clock is released
*         - AC_MSG_CANCELPRESS – Clock will be released, user cancels press action on the clock
*         - OBJ_MSG_INVALID – Clock is not affected
*
* Example:
*   <CODE> 
...
*						objMsg = AcTranslateMsg((ANALOGCLOCK*)pCurrentObj, pMsg);
*						if(objMsg == OBJ_MSG_INVALID)
*							break;
*						if(GOLMsgCallback(objMsg,pCurrentObj,pMsg))
*							AcMsgDefault(objMsg,(ANALOGCLOCK*)pCurrentObj);
*						break;
*					case OBJ_SLIDER:
...
*    	Translated Message   Input Source	Set/Clear State Bit		Description
*     	##################   ############	######     				###########
*     	AC_MSG_PRESSED      Touch Screen,	Set AC_PRESSED  		
*     					      Keyboard	     				
*		AC_MSG_RELEASED	 Touch Screen,	Clear AC_PRESSED		
*							  Keyboard        				
*		AC_MSG_CANCELPRESS	 Touch Screen,	Clear AC_PRESSED		
*							         				
*	</TABLE>
*
* PreCondition: none
...
*        pAc            - The pointer to the object whose state will be modified.
