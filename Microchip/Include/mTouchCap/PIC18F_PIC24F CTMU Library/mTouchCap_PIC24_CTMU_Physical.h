...
/* ~~~~~~~~~~~~~~~~~~~~~	Externs  	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  	*/
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
extern WORD curBigData		[MAX_ADC_CHANNELS]; //Storage for CTMU values
...
extern WORD	smallAvg		[MAX_ADC_CHANNELS];	// current button small avg
...
/***************************************************************************************/
#ifdef  ADC_LEGACY 											//To Configure Port pin as Analog by clearing the port pin

#define DIGITAL                   1							//Set port pin to make it as Digital I/O
#define ANALOG	                  0							//Clear port pin to make it as Analog

/*******Initialization of Analog channels for 24F04KA200 and 24F16KA101 Family devices ********/
...
#define TRIS_CHANNEL_AN2  				TRISAbits.TRISA4
#define TRIS_CHANNEL_AN3  				TRISBbits.TRISB4
#define TRIS_CHANNEL_AN4  				TRISBbits.TRISB7
#define TRIS_CHANNEL_AN5  				TRISBbits.TRISB8
#define TRIS_CHANNEL_AN6  				TRISBbits.TRISB9
#define TRIS_CHANNEL_AN7  				TRISBbits.TRISB14
#define TRIS_CHANNEL_AN8  				TRISBbits.TRISB15


#define ADC_CHANNEL_AN0(Value) 		AD1PCFGbits.PCFG0 = Value;			//To make Port pin as Analog or Digital I/O
#define ADC_CHANNEL_AN1(Value) 		AD1PCFGbits.PCFG1 = Value;
#define ADC_CHANNEL_AN2(Value) 		AD1PCFGbits.PCFG2 = Value;
#define ADC_CHANNEL_AN3(Value) 		AD1PCFGbits.PCFG3 = Value;
#define ADC_CHANNEL_AN4(Value) 		AD1PCFGbits.PCFG4 = Value;
#define ADC_CHANNEL_AN5(Value) 		AD1PCFGbits.PCFG5 = Value;
#define ADC_CHANNEL_AN6(Value) 		AD1PCFGbits.PCFG10 = Value;
#define ADC_CHANNEL_AN7(Value) 		AD1PCFGbits.PCFG11 = Value;
#define ADC_CHANNEL_AN8(Value) 		AD1PCFGbits.PCFG12 = Value;

/******** Initialization of Analog channels for 24FJ32GA102 and 24FJ32GB104 Family devices ********/
#elif defined(__PIC24FJ32GA102__) || defined(__PIC24FJ32GA104__) || defined(__PIC24FJ64GA102__)\
 || defined(__PIC24FJ64GA104__) || defined(__PIC24FJ32GB002__) || defined(__PIC24FJ32GB004__)\
 || defined(__PIC24FJ64GB002__) || defined(__PIC24FJ64GB004__) 

#define TRIS_CHANNEL_AN0				TRISBbits.TRISB0				//To select Port pin as Input or output
...
#define TRIS_CHANNEL_AN6  				TRISBbits.TRISB7
#define TRIS_CHANNEL_AN7  				TRISBbits.TRISB8
#define TRIS_CHANNEL_AN8  				TRISBbits.TRISB9
#define TRIS_CHANNEL_AN9  				TRISBbits.TRISB10
#define TRIS_CHANNEL_AN1O  				TRISBbits.TRISB11
#define TRIS_CHANNEL_AN11  				TRISBbits.TRISB13
...
#define ADC_CHANNEL_AN4(Value) 		AD1PCFGbits.PCFG4 = Value;
#define ADC_CHANNEL_AN5(Value) 		AD1PCFGbits.PCFG5 = Value;
#define ADC_CHANNEL_AN6(Value) 		AD1PCFGbits.PCFG9 = Value;
#define ADC_CHANNEL_AN7(Value) 		AD1PCFGbits.PCFG10 = Value;
#define ADC_CHANNEL_AN8(Value) 		AD1PCFGbits.PCFG11 = Value;
#define ADC_CHANNEL_AN9(Value) 		AD1PCFGbits.PCFG13 = Value;
#define ADC_CHANNEL_AN10(Value)		AD1PCFGbits.PCFG14 = Value;
#define ADC_CHANNEL_AN11(Value)		AD1PCFGbits.PCFG15 = Value;


#else 

/******** Initialization of Analog channels for 24FJ128GA110 & 24FJ128GB110 Family devices********/
#define TRIS_CHANNEL_AN0				TRISBbits.TRISB0				//To select Port pin as Input or output
#define TRIS_CHANNEL_AN1  				TRISBbits.TRISB1
#define TRIS_CHANNEL_AN2  				TRISBbits.TRISB2
#define TRIS_CHANNEL_AN3  				TRISBbits.TRISB3
...
#define TRIS_CHANNEL_AN16  				TRISCbits.TRISC1
#define TRIS_CHANNEL_AN17  				TRISCbits.TRISC2
...
#define ADC_CHANNEL_AN4(Value) 		AD1PCFGbits.PCFG4 = Value;
#define ADC_CHANNEL_AN5(Value) 		AD1PCFGbits.PCFG5 = Value;
#define ADC_CHANNEL_AN6(Value) 		AD1PCFGbits.PCFG6 = Value;
#define ADC_CHANNEL_AN7(Value) 		AD1PCFGbits.PCFG7 = Value;
#define ADC_CHANNEL_AN8(Value) 		AD1PCFGbits.PCFG8 = Value;
#define ADC_CHANNEL_AN9(Value) 		AD1PCFGbits.PCFG9 = Value;
#define ADC_CHANNEL_AN10(Value)		AD1PCFGbits.PCFG10 = Value;
#define ADC_CHANNEL_AN11(Value)		AD1PCFGbits.PCFG11 = Value;
#define ADC_CHANNEL_AN12(Value)		AD1PCFGbits.PCFG12 = Value;
#define ADC_CHANNEL_AN13(Value)		AD1PCFGbits.PCFG13 = Value;
#define ADC_CHANNEL_AN14(Value)		AD1PCFGbits.PCFG14 = Value;
#define ADC_CHANNEL_AN15(Value)		AD1PCFGbits.PCFG15 = Value;
#define ADC_CHANNEL_AN16(Value)		AD1PCFGHbits.PCFG16 = Value;
#define ADC_CHANNEL_AN17(Value)		AD1PCFGHbits.PCFG17 = Value;

#endif

#endif

#ifdef  ADC_NEW									//To Configure Port pin as Analog by setting the port pin

#define DIGITAL                 	0			//Clear port pin to make it as Digital I/O
#define ANALOG	                	1			//Set port pin to make it as Analog

/******** Initialization of Analog channels for 24F16KA304 & 24FV16KA304 Family devices ********/
...
#define TRIS_CHANNEL_AN4  				TRISBbits.TRISB0
#define TRIS_CHANNEL_AN5  				TRISBbits.TRISB1
#define TRIS_CHANNEL_AN6  				TRISBbits.TRISB2
#define TRIS_CHANNEL_AN7 				TRISBbits.TRISB4
#define TRIS_CHANNEL_AN8  				TRISBbits.TRISB12
#define TRIS_CHANNEL_AN9  				TRISBbits.TRISB13
#define TRIS_CHANNEL_AN10  				TRISBbits.TRISB14
#define TRIS_CHANNEL_AN11  				TRISBbits.TRISB15


#define ADC_CHANNEL_AN0(Value) 			_ANSA0 = Value;		//To make Port pin as Analog or Digital I/O
#define ADC_CHANNEL_AN1(Value) 			_ANSA1 = Value;
#define ADC_CHANNEL_AN2(Value) 			_ANSA2 = Value;
#define ADC_CHANNEL_AN3(Value) 			_ANSA3 = Value;
#define ADC_CHANNEL_AN4(Value) 			_ANSB0 = Value;
#define ADC_CHANNEL_AN5(Value) 			_ANSB1 = Value;
#define ADC_CHANNEL_AN6(Value) 			_ANSB2 = Value;
#define ADC_CHANNEL_AN7(Value) 			_ANSB4 = Value;
#define ADC_CHANNEL_AN8(Value)			_ANSB12= Value;
#define ADC_CHANNEL_AN9(Value)			_ANSB13= Value;
#define ADC_CHANNEL_AN10(Value)			_ANSB14= Value;
#define ADC_CHANNEL_AN11(Value)			_ANSB15= Value;


/* Initialization of Analog channels for  24FJ128DA206 & 24FJ128GB206 (64 pin devices)Family devices */
...
#define ADC_CHANNEL_AN0(Value) 		ANSBbits.ANSB0 = Value;			//To make Port pin as Analog or Digital I/O
#define ADC_CHANNEL_AN1(Value) 		ANSBbits.ANSB1 = Value;
#define ADC_CHANNEL_AN2(Value) 		ANSBbits.ANSB2 = Value;
#define ADC_CHANNEL_AN3(Value) 		ANSBbits.ANSB3 = Value;
#define ADC_CHANNEL_AN4(Value) 		ANSBbits.ANSB4 = Value;
#define ADC_CHANNEL_AN5(Value) 		ANSBbits.ANSB5 = Value;
#define ADC_CHANNEL_AN6(Value) 		ANSBbits.ANSB6 = Value;
#define ADC_CHANNEL_AN7(Value) 		ANSBbits.ANSB7 = Value;
#define ADC_CHANNEL_AN8(Value) 		ANSBbits.ANSB8 = Value;
#define ADC_CHANNEL_AN9(Value) 		ANSBbits.ANSB9 = Value;
#define ADC_CHANNEL_AN10(Value)		ANSBbits.ANSB10 = Value;
#define ADC_CHANNEL_AN11(Value)		ANSBbits.ANSB11= Value;
#define ADC_CHANNEL_AN12(Value)		ANSBbits.ANSB12= Value;
#define ADC_CHANNEL_AN13(Value)		ANSBbits.ANSB13= Value;
#define ADC_CHANNEL_AN14(Value)		ANSBbits.ANSB14= Value;
#define ADC_CHANNEL_AN15(Value)		ANSBbits.ANSB15= Value;
...
#define TRIS_CHANNEL_AN22  				TRISAbits.TRISA6
#define TRIS_CHANNEL_AN23  				TRISAbits.TRISA7
...
#define ADC_CHANNEL_AN16(Value)		ANSCbits.ANSC4 = Value;
#define ADC_CHANNEL_AN17(Value)		ANSGbits.ANSG6 = Value;
#define ADC_CHANNEL_AN18(Value)		ANSGbits.ANSG7 = Value;
#define ADC_CHANNEL_AN19(Value)		ANSGbits.ANSG8 = Value;

#define ADC_CHANNEL_AN20(Value)		ANSGbits.ANSG9 = Value;
#define ADC_CHANNEL_AN21(Value)		ANSEbits.ANSE9 = Value;
#define ADC_CHANNEL_AN22(Value)		ANSAbits.ANSA7 = Value;
#define ADC_CHANNEL_AN23(Value)		ANSAbits.ANSA6 = Value;
...
#define 	INIT_AD1PCFGH_VALUE		0x0000
...
#define Adc_Port_Configuration(Value)	 (AD1PCFG = Value)  // Configure ADC port for Low Pin Devices
#else 
#define Adc_Port_Configuration(Value)	 (AD1PCFGL = Value)	// Configure ADC port 
#define Adc_Port_Hgh_Configuration(Value)(AD1PCFGH = Value) // Configure ADC port 
#endif
#endif
...
#if __C30_VERSION__ < 330									
#define ANSA  ANSELA										// The SFR name in C-30 3.25 is ANSELA and that needs to be replaced by ANSA 
#define ANSB  ANSELB										// according to C-30 3.30 compiler ,data sheet and the code
#define ANSC  ANSELC
#endif

#define Adc_PortA_Configuration(Value)	(ANSA = Value)		// Configure ADC port
...
**************************************************************************/
#if defined(__PIC24FJ64GA108__)  || defined(__PIC24FJ64GA110__)
#define ADC_CHANNEL_SELECT 			AD1CHS0
#else
...
||  defined(__PIC24FV16KA301__)  || defined (__PIC24FV16KA302__) || defined(__PIC24FV16KA304__)\
||  defined(__PIC24FV32KA301__)  || defined (__PIC24FV32KA302__) || defined(__PIC24FV32KA304__)
#define ADC_PORTA_CONFIG_DEFAULT_VALUE 	0x000F			// Default Value of ADC Port Configuration Register.
#define ADC_PORTB_CONFIG_DEFAULT_VALUE 	0xF017

#elif defined(__PIC24FJ128DA106__) ||  defined(__PIC24FJ128DA206__) || defined(__PIC24FJ256DA106__)\
 || defined(__PIC24FJ256DA206__) ||  defined(__PIC24FJ128GB206__) || defined(__PIC24FJ256GB206__)
#define ADC_PORTB_CONFIG_DEFAULT_VALUE 	0xFFFF			// Default Value of ADC Port Configuration Register.
...
#if defined CTMU_v1 || defined CTMU_v2
...
Remarks     : None.
**************************************************************************/ 
#define Set_CTMU_ENABLE_Status(State)   		(CTMUCON1bits.CTMUEN = State)
...
Remarks     : None.
**************************************************************************/ 
#define Idle_Mode_CTMU_Operation(State)   		(CTMUCON1bits.CTMUSIDL = State)
...
Remarks     : None.
**************************************************************************/ 
#define Set_CTMU_Time_Generation(State)   		(CTMUCON1bits.TGEN = State)
...
Remarks     : None.
**************************************************************************/ 
#define Block_CTMU_Edge(State)   				(CTMUCON1bits.EDGEN = 0)
...
Remarks     : None.
**************************************************************************/ 
#define Unblock_CTMU_Edge(State)   				(CTMUCON1bits.EDGEN = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Set_Edge_Sequence(State)   				(CTMUCON1bits.EDGSEQEN = State)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMU_CurrentDischarge   			(CTMUCON1bits.IDISSEN = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Disble_CTMU_CurrentDischarge   			(CTMUCON1bits.IDISSEN = 0)
...
Remarks     : None.
**************************************************************************/ 
#define Set_CTMU_Trigger_Control(State)   		(CTMUCON1bits.CTTRIG = State)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMU_Positive_Edge2_Polarity		(CTMUCON2bits.EDG2POL = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMU_Negative_Edge2_Polarity		(CTMUCON2bits.EDG2POL = 0)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMU_Positive_Edge1_Polarity		(CTMUCON2bits.EDG1POL = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMU_Negative_Edge1_Polarity		(CTMUCON2bits.EDG1POL = 0)
...
Remarks     : None.
**************************************************************************/ 
#define CTMU_Edge1_Source_Select(State)   		(CTMUCON2bits.EDG1SEL = State)
...
Remarks     : None.
**************************************************************************/ 
#define CTMU_Edge2_Source_Select(State)   		(CTMUCON2bits.EDG2SEL = State)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMUEdge1  						(CTMUCON2bits.EDG1 = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CTMUEdge2 						(CTMUCON2bits.EDG2 = 1)
...
Remarks     : None.
**************************************************************************/ 
#define Enble_CurrentSource   					(CTMUCON2bits.EDG1 = 1 , CTMUCON2bits.EDG2 = 1 )
...
#endif //#ifdef CTMU_v1 || defined CTMU_v2
