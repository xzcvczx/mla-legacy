...
extern WORD	channel_TRIM_value	[MAX_ADC_CHANNELS];//Trim value of the channels
extern WORD	channel_IRNG_value	[MAX_ADC_CHANNELS];//Value of current to all the channels
...
extern BYTE Press_State 	[MAX_ADC_CHANNELS];// Storage for the pressed state
extern SHORT startupCount;						// variable to 'discard' first N samples
extern SHORT loopCount;							// Storage of count for loop
...
/**************************************************************************************/
/***In some of the controllers to make Port pin as Analog, they should be made low and in other controllers its 
viceversa. Depending on the controller selected, port bit is made Low/High to configure it as Analog **********/

#ifdef ADC_ANCON_LEGACY					//To Configure Port pin as Analog clear the port pin

	#define DIGITAL                 1	//Set port pin to make it as Digital I/O
	#define ANALOG	                0	//Clear port pin to make it as Analog

#else									//To Configure Port pin as Analog set the port pin

	#define DIGITAL                 0	//Clear port pin to make it as Digital I/O
	#define ANALOG	                1	//Set port pin to make it as Analog

#endif

/*************** Configuration of Port pin as Analog or Digital for controllers with ANCONx register  **************/

#ifdef ADC_ANCON_LEGACY	

#if defined(__18F44J50)  || defined(__18F45J50) || defined(__18F46J50)|| defined(__18LF44J50)  || defined(__18LF45J50) || defined(__18LF46J50)\
  || defined(__18F44J11)  || defined(__18F45J11) || defined(__18F46J11)  ||defined(__18LF44J11)  || defined(__18LF45J11) || defined(__18LF46J11)\
  || defined(__18F46J53) || defined(__18F47J53)  ||	defined(__18LF46J53) || defined(__18LF47J53)\
  || defined(__18F46J13)|| defined(__18F47J13)   || defined(__18LF46J13) || defined(__18LF47J13)

	

	#define TRIS_CHANNEL_AN0			TRISAbits.TRISA0				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN1  			TRISAbits.TRISA1				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN2  			TRISAbits.TRISA2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN3  			TRISAbits.TRISA3				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN4  			TRISAbits.TRISA5				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN5  			TRISEbits.TRISE0				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN6  			TRISEbits.TRISE1				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN7  			TRISEbits.TRISE2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN8  			TRISBbits.TRISB2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN9  			TRISBbits.TRISB3				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN1O  			TRISBbits.TRISB1				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN11  			TRISCbits.TRISC2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN12  			TRISBbits.TRISB0				//To select Port pin as Input or output
	
	#define ADC_CHANNEL_AN0(Value) 		ANCON0bits.PCFG0 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN1(Value) 		ANCON0bits.PCFG1 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN2(Value) 		ANCON0bits.PCFG2 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN3(Value) 		ANCON0bits.PCFG3 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN4(Value) 		ANCON0bits.PCFG4 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN5(Value) 		ANCON0bits.PCFG5 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN6(Value) 		ANCON0bits.PCFG6 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN7(Value) 		ANCON0bits.PCFG7 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN8(Value) 		ANCON1bits.PCFG8 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN9(Value) 		ANCON1bits.PCFG9 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN10(Value)		ANCON1bits.PCFG10 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN11(Value)		ANCON1bits.PCFG11 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN12(Value)		ANCON1bits.PCFG12 = Value;	//To make Port pin to act as Analog or Digital I/O
	...
	#define TRIS_CHANNEL_AN5  			TRISBbits.TRISB2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN6  			TRISBbits.TRISB3				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN7  			TRISBbits.TRISB1				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN8  			TRISCbits.TRISC2				//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN9  			TRISBbits.TRISB0				//To select Port pin as Input or output
	...
	#define ADC_CHANNEL_AN5(Value) 		ANCON1bits.PCFG8 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN6(Value) 		ANCON1bits.PCFG9 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN7(Value)		ANCON1bits.PCFG10 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN8(Value)		ANCON1bits.PCFG11 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN9(Value)		ANCON1bits.PCFG12 = Value;	//To make Port pin to act as Analog or Digital I/O
...
/*************** Configuration of Port pin as Analog or Digital for controllers with ADCON register  **************/
#ifdef ADC_ADCON_LEGACY								
	...
	#define TRIS_CHANNEL_AN3  			TRISAbits.TRISA3	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN4  			TRISAbits.TRISA5	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN5  			TRISFbits.TRISF7	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN6  			TRISFbits.TRISF1	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN7  			TRISFbits.TRISF2	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN8  			TRISFbits.TRISF3	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN9  			TRISFbits.TRISF4	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN1O  			TRISFbits.TRISF5	//To select Port pin as Input or output
	#define TRIS_CHANNEL_AN11  			TRISFbits.TRISF6	//To select Port pin as Input or output
	

	#define ADC_COMBINE_CHANNEL(Value) 	ADCON1bits.PCFG = Value;	//To make Port pin to act as Analog or Digital I/O

#endif 
	
/*************** Configuration of Port pin as Analog or Digital for controllers with ANSELx register  **************/
#ifdef ADC_ANSEL_NEW
  ...
  ||defined(__18LF43K22)  || defined(__18LF44K22) || defined(__18LF45K22) || defined(__18LF46K22)
	...
	#define TRIS_CHANNEL_AN11  			TRISBbits.TRISB4
	#define TRIS_CHANNEL_AN12			TRISBbits.TRISB0
	#define TRIS_CHANNEL_AN13 			TRISBbits.TRISB5
	#define TRIS_CHANNEL_AN14 			TRISCbits.TRISC2
	#define TRIS_CHANNEL_AN15 			TRISCbits.TRISC3
	#define TRIS_CHANNEL_AN16 			TRISCbits.TRISC4
	#define TRIS_CHANNEL_AN17 			TRISCbits.TRISC5
	#define TRIS_CHANNEL_AN18 			TRISCbits.TRISC6
	#define TRIS_CHANNEL_AN19 			TRISCbits.TRISC7
	#define TRIS_CHANNEL_AN20 			TRISDbits.TRISD0
	#define TRIS_CHANNEL_AN21 			TRISDbits.TRISD1
	#define TRIS_CHANNEL_AN22  			TRISDbits.TRISD2
	#define TRIS_CHANNEL_AN23  			TRISDbits.TRISD3
	#define TRIS_CHANNEL_AN24 			TRISDbits.TRISD4
	#define TRIS_CHANNEL_AN25 			TRISDbits.TRISD5
	#define TRIS_CHANNEL_AN26 			TRISDbits.TRISD6
	#define TRIS_CHANNEL_AN27 			TRISDbits.TRISD7

	
	#define ADC_CHANNEL_AN0(Value) 		ANSELAbits.ANSA0 = Value;		//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN1(Value) 		ANSELAbits.ANSA1 = Value;
	#define ADC_CHANNEL_AN2(Value) 		ANSELAbits.ANSA2 = Value;
	#define ADC_CHANNEL_AN3(Value) 		ANSELAbits.ANSA3 = Value;
	#define ADC_CHANNEL_AN4(Value) 		ANSELAbits.ANSA5 = Value;
	#define ADC_CHANNEL_AN5(Value) 		ANSELBbits.ANSB0 = Value;
	#define ADC_CHANNEL_AN6(Value) 		ANSELBbits.ANSB1 = Value;
	#define ADC_CHANNEL_AN7(Value) 		ANSELBbits.ANSB2 = Value;
	#define ADC_CHANNEL_AN8(Value) 		ANSELBbits.ANSB3 = Value;
	#define ADC_CHANNEL_AN9(Value) 		ANSELBbits.ANSB4 = Value;
	#define ADC_CHANNEL_AN10(Value)		ANSELBbits.ANSB5 = Value;
	#define ADC_CHANNEL_AN11(Value) 	ANSELCbits.ANSC2 = Value;
	#define ADC_CHANNEL_AN12(Value) 	ANSELCbits.ANSC3 = Value;
	#define ADC_CHANNEL_AN13(Value) 	ANSELCbits.ANSC4 = Value;
	#define ADC_CHANNEL_AN14(Value) 	ANSELCbits.ANSC5 = Value;
	#define ADC_CHANNEL_AN15(Value) 	ANSELCbits.ANSC6 = Value;
	#define ADC_CHANNEL_AN16(Value)		ANSELCbits.ANSC7 = Value;
	#define ADC_CHANNEL_AN17(Value) 	ANSELDbits.ANSD0 = Value;
	#define ADC_CHANNEL_AN18(Value) 	ANSELDbits.ANSD1 = Value;
	#define ADC_CHANNEL_AN19(Value) 	ANSELDbits.ANSD2 = Value;
	#define ADC_CHANNEL_AN20(Value) 	ANSELDbits.ANSD3 = Value;
	#define ADC_CHANNEL_AN21(Value) 	ANSELDbits.ANSD4 = Value;
	#define ADC_CHANNEL_AN22(Value)		ANSELDbits.ANSD5 = Value;
	#define ADC_CHANNEL_AN23(Value) 	ANSELDbits.ANSD6 = Value;
	#define ADC_CHANNEL_AN24(Value)		ANSELDbits.ANSD7 = Value;
	#define ADC_CHANNEL_AN25(Value)		ANSELEbits.ANSE0 = Value;
	#define ADC_CHANNEL_AN26(Value) 	ANSELEbits.ANSE1 = Value;
	#define ADC_CHANNEL_AN27(Value)		ANSELEbits.ANSE2 = Value;
...
/*************** Configuration of Port pin as Analog or Digital for controllers with ANCONxx register  **************/
#ifdef ADC_ANCON_NEW

#if defined(__18F85K22)  || defined(__18F86K22) || defined(__18F87K22) || defined(__18F85K90)  || defined(__18F86K90) || defined(__18F87K90)
	...
	#define TRIS_CHANNEL_AN3  			TRISAbits.TRISA3
	#define TRIS_CHANNEL_AN4  			TRISAbits.TRISA5
	#define TRIS_CHANNEL_AN5  			TRISFbits.TRISF7
	#define TRIS_CHANNEL_AN6  			TRISFbits.TRISF1
	#define TRIS_CHANNEL_AN7  			TRISFbits.TRISF2
	#define TRIS_CHANNEL_AN8  			TRISFbits.TRISF3
	#define TRIS_CHANNEL_AN9  			TRISFbits.TRISF4
	#define TRIS_CHANNEL_AN1O  			TRISFbits.TRISF5
	#define TRIS_CHANNEL_AN11  			TRISFbits.TRISF6
	#define TRIS_CHANNEL_AN12			TRISHbits.TRISH4		
	#define TRIS_CHANNEL_AN13 			TRISHbits.TRISH5
	#define TRIS_CHANNEL_AN14 			TRISHbits.TRISH6
	#define TRIS_CHANNEL_AN15 			TRISHbits.TRISH7
	#define TRIS_CHANNEL_AN16 			TRISGbits.TRISG4
	#define TRIS_CHANNEL_AN17 			TRISGbits.TRISG3
	#define TRIS_CHANNEL_AN18 			TRISGbits.TRISG2
	#define TRIS_CHANNEL_AN19 			TRISGbits.TRISG1
	#define TRIS_CHANNEL_AN20 			TRISHbits.TRISH3
	#define TRIS_CHANNEL_AN21 			TRISHbits.TRISH2
	#define TRIS_CHANNEL_AN22  			TRISHbits.TRISH1
	#define TRIS_CHANNEL_AN23  			TRISHbits.TRISH0


	#define ADC_CHANNEL_AN0(Value) 		ANCON0bits.ANSEL0 = Value;	//To make Port pin to act as Analog or Digital I/O
	#define ADC_CHANNEL_AN1(Value) 		ANCON0bits.ANSEL1 = Value;
	#define ADC_CHANNEL_AN2(Value) 		ANCON0bits.ANSEL2 = Value;
	#define ADC_CHANNEL_AN3(Value) 		ANCON0bits.ANSEL3 = Value;
	#define ADC_CHANNEL_AN4(Value) 		ANCON0bits.ANSEL4 = Value;
	#define ADC_CHANNEL_AN5(Value) 		ANCON0bits.ANSEL5 = Value;
	#define ADC_CHANNEL_AN6(Value) 		ANCON0bits.ANSEL6 = Value;
	#define ADC_CHANNEL_AN7(Value) 		ANCON0bits.ANSEL7 = Value;
	#define ADC_CHANNEL_AN8(Value) 		ANCON1bits.ANSEL8 = Value;
	#define ADC_CHANNEL_AN9(Value) 		ANCON1bits.ANSEL9 = Value;
	#define ADC_CHANNEL_AN10(Value)		ANCON1bits.ANSEL10 = Value;
	#define ADC_CHANNEL_AN11(Value) 	ANCON1bits.ANSEL11 = Value;
	#define ADC_CHANNEL_AN12(Value) 	ANCON1bits.ANSEL12 = Value;		
	#define ADC_CHANNEL_AN13(Value) 	ANCON1bits.ANSEL13 = Value;
	#define ADC_CHANNEL_AN14(Value) 	ANCON1bits.ANSEL14 = Value;
	#define ADC_CHANNEL_AN15(Value) 	ANCON1bits.ANSEL15 = Value;
	#define ADC_CHANNEL_AN16(Value)		ANCON2bits.ANSEL16 = Value;
	#define ADC_CHANNEL_AN17(Value) 	ANCON2bits.ANSEL17 = Value;
	#define ADC_CHANNEL_AN18(Value) 	ANCON2bits.ANSEL18 = Value;
	#define ADC_CHANNEL_AN19(Value) 	ANCON2bits.ANSEL19 = Value;
	#define ADC_CHANNEL_AN20(Value) 	ANCON2bits.ANSEL20 = Value;
	#define ADC_CHANNEL_AN21(Value) 	ANCON2bits.ANSEL21 = Value;
	#define ADC_CHANNEL_AN22(Value)		ANCON2bits.ANSEL22 = Value;
	#define ADC_CHANNEL_AN23(Value) 	ANCON2bits.ANSEL23 = Value;
	...
	#define TRIS_CHANNEL_AN1O  			TRISFbits.TRISF5
	#define TRIS_CHANNEL_AN11  			TRISFbits.TRISF6	
	#define TRIS_CHANNEL_AN12 			TRISGbits.TRISG4
	#define TRIS_CHANNEL_AN13 			TRISGbits.TRISG3
	#define TRIS_CHANNEL_AN14 			TRISGbits.TRISG2
	#define TRIS_CHANNEL_AN15 			TRISGbits.TRISG1
	...
	#define ADC_CHANNEL_AN12(Value)		ANCON2bits.ANSEL16 = Value;
	#define ADC_CHANNEL_AN13(Value) 	ANCON2bits.ANSEL17 = Value;
	#define ADC_CHANNEL_AN14(Value) 	ANCON2bits.ANSEL18 = Value;
	#define ADC_CHANNEL_AN15(Value) 	ANCON2bits.ANSEL19 = Value;
...
/***************controllers with ANCONx registers to Configure ADC Port pin as Analog or Digital **************/
#ifdef ADC_ANCON_LEGACY
...
/*************** controllers with  ADCONx register to Configure ADC Port pin as Analog or Digital **************/
#ifdef ADC_ADCON_LEGACY
...
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration1(Value)	(ADCON1bits.PCFG = Value)

#endif

/*************** controllers with ANSELx registers to Configure ADC Port pin as Analog or Digital **************/
#ifdef ADC_ANSEL_NEW
...
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration1(Value)	(ANSELA = Value)
/************************************************************************
Macro       : Adc_Port_Configuration2
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration2(Value)	(ANSELB = Value)
/************************************************************************
Macro       : Adc_Port_Configuration3
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration3(Value)	(ANSELC = Value)
/************************************************************************
Macro       : Adc_Port_Configuration4
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration4(Value)	(ANSELD = Value)
/************************************************************************
Macro       : Adc_Port_Configuration5
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration5(Value)	(ANSELE = Value)
...
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration1(Value)	(ANCON0 = Value)
/************************************************************************
Macro       : Adc_Port_Configuration5
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration2(Value)	(ANCON1 = Value)
/************************************************************************
Macro       : Adc_Port_Configuration5
Overview    : Configure ADC Port pin as Analog or Digital for register0
Parameters  : None
Remarks     : None.
**************************************************************************/
#define Adc_Port_Configuration3(Value)	(ANCON2 = Value)
...
/*****Controllers with ADC conversion_Clock, Acquisition_Time defined in ADCON2 register*********************/  
#if defined ADC_ADCON_LEGACY || defined ADC_ANSEL_NEW ||  defined ADC_ANCON_NEW 

/**************Redefining ADC Register *********************/
#define AD_CON_REG2						ADCON2

/******ADCON1 and ADCON2 register Values***********/

#define ADC_CONFIG_ADCON1  (ADCON0_VAL | ADC_REF_VDD_VSS) 
#define ADC_CONFIG_ADCON2  (ADCON1_VAL | ADC_RIGHT_JUST | ADC_FOSC_4 | ADC_2_TAD)
...
//***********A/D Channel Selection for controllers which as uses combination of register value **********//

#define ADC_AN0 	0b1110		//Select Channel 0
#define ADC_AN1		0b1101		//Select Channel 1
#define ADC_AN2		0b1100		//Select Channel 2
#define ADC_AN3		0b1011		//Select Channel 3
#define ADC_AN4		0b1010		//Select Channel 4
#define ADC_AN5		0b1001		//Select Channel 5
#define ADC_AN6		0b1000		//Select Channel 6
#define ADC_AN7		0b0111		//Select Channel 7
#define ADC_AN8		0b0110		//Select Channel 8
#define ADC_AN9		0b0101		//Select Channel 9
#define ADC_AN10	0b0100		//Select Channel 10
#define ADC_AN11	0b0011		//Select Channel 11
