...
#define DELAY_PRESCALER   (BYTE)      8					//Prescalar value
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
	...
	#define STOP_TIMER_IN_IDLE_MODE     	0x2000				//No idle mode
	#define TIMER_SOURCE_INTERNAL       	0x0000				// Internal clock  for Timer
	#define TIMER_ON                    	0x8000				// Enable Timer
	#define GATED_TIME_DISABLED         	0x0000				// Disable gated mode
	#define TIMER_16BIT_MODE            	0x0000				// Enable 16 bit mode
	#define TIMER_PRESCALER_1           	0x0000				// Timer prescalar 1:1
	#define TIMER_PRESCALER_8           	0x0010				// Timer prescalar 1:8
	#define TIMER_PRESCALER_64          	0x0020				// Timer prescalar 1:64
	#define TIMER_PRESCALER_256         	0x0030				// Timer prescalar 1:256
	#define TIMER_INTERRUPT_PRIORITY    	0x1000				// Interrupt priority for Timer
	...
	#define TIMER_PRESCALER_VALUE			4					// Timer prescalar 
...
Overview    : setting or clearing T4 / T2 (PIC 24F below defined devices) Interrupt Flag Bit 
...
#define Set_ScanTimer_IF_Bit_State(State)   			(IFS0bits.T2IF = State)
#else  
...
Overview    : setting or clearing T4 / T2 (PIC 24F below defined devices)Interrupt Enable Bit 
Parameters  : ENABLE '1' or DISABLE '0' 
Remarks     : None.
**************************************************************************/ 
#if defined(__PIC24F04KA200__) || defined(__PIC24F04KA201__) || defined(__PIC24F08KA101__)\
|| defined(__PIC24F08KA102__)  || defined(__PIC24F16KA101__)  || defined(__PIC24F16KA102__)
#define Set_ScanTimer_IE_Bit_State(State)   			(IEC0bits.T2IE = State)
#else  
...
Overview    : setting or clearing T4/ T2 (PIC 24F below defined devices) ON bit
Parameters  : ENABLE '1' or DISABLE '0' 
Remarks     : None.
**************************************************************************/ 
...
#if defined(__PIC24F04KA200__) || defined(__PIC24F04KA201__) || defined(__PIC24F08KA101__)\
|| defined(__PIC24F08KA102__)  || defined(__PIC24F16KA101__)  || defined(__PIC24F16KA102__)
#define Set_ScanTimer_ON_Bit_State(State)   			(T2CONbits.TON = State)
#else
