...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - WiFi Iperf App-C18" /s /q
rmdir "Objects - WiFi Iperf App-C30" /s /q
rmdir "Objects - WiFi Iperf App-C32" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - WiFi Iperf App-C18" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - WiFi Iperf App-C30" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - WiFi Iperf App-C32" /s /q
