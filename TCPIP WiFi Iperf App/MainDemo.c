...
#define kZGMaxCmdStringSize  (12)
#if defined (STACK_USE_IPERF)
static ROM tZGU8 cmdStrings[][kZGMaxCmdStringSize] = { {"iperf"}, {"kill"} };
#define kZGNumCmdsInList (sizeof(cmdStrings) / kZGMaxCmdStringSize)
ROM tZGU8 *p_cmdStringPtrList[kZGNumCmdsInList] = { cmdStrings[0], cmdStrings[1]};
#else
static ROM tZGU8 cmdStrings[][kZGMaxCmdStringSize] = {  };
#define kZGNumCmdsInList (sizeof(cmdStrings) / kZGMaxCmdStringSize)
ROM tZGU8 *p_cmdStringPtrList[kZGNumCmdsInList] = { };
...
/*	strcpypgm2ram((char*)LCDText, "ZeroG SDK v2.1 "
								  "TCPStack " VERSION "  "); */
	LCDUpdate();
