...
/*******************************************************************/
    ...
    /*******************************************************************/ 		
		...
		//Get Smart Card Present status
		#define SCdrv_CardPresent()	      				(PORTBbits.RB8 || !PORTAbits.RA1)
		...
		//Set Card Present Pin direction connected to the smart card
		#define SCdrv_CardPresent_Direction(flag) 		(TRISBbits.TRISB8 = flag)
    ...
    /*******************************************************************/ 
        ...
        #define SCdrv_SetClockPinLow() LATCbits.LATC5 = 0;
        #define SCdrv_SetClockPinHigh() LATCbits.LATC5 = 1;
